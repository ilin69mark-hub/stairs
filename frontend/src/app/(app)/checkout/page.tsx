    ...
    try {
      const response = await createOrder({
        ...
        stairConfig: {
          ...
          openingWidth: currentConfig.openingWidth,
          openingLength: currentConfig.openingLength,
          stepWidth: currentConfig.stepWidth,
          material: currentConfig.material,
          railing: currentConfig.railing,
          coating: currentConfig.coating,
        },
      });
      clearCart();
      router.push(`/checkout/success?orderNumber=${response.orderNumber}`);
    } catch (error) {
      setSubmitError(error instanceof Error ? error.message : "Ошибка при оформлении заказа");
    }
  };
