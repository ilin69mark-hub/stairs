  ...
  return (
    <div className="w-[400px] flex-shrink-0 bg-white border-r overflow-y-auto p-6">
      ...
      <div className="fixed bottom-0 left-0 w-[400px] bg-white border-t shadow-lg p-4 space-y-3 z-10">
        {calculatedResult && calculatedResult.warnings && calculatedResult.warnings.length > 0 && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <div className="text-sm font-medium text-amber-800 mb-1">Предупреждения СНиП:</div>
            <ul className="text-xs text-amber-700 space-y-1 max-h-20 overflow-y-auto">
